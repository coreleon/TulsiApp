...
import com.quickveggies.db.erp.gl.charts.ArrivalsChart;
...
public class DSalesTransController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ArrivalsChart.initialize(arrivalBarChart, filterSelection, turnover, totalCases, lines, salesDashTable);
