...
public class CompanyInfoViewController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		final Company c = Company.getCurrentCompany();
		if (c != null) {
			...
			btnAddCompany.setVisible(false);
                        btnEditCompany.setVisible(c.ownedBy(User.getCurrentUser()));
                    } else {
                        btnAddCompany.setVisible(User.getCurrentUser().canCreateCompany());
